      ...
      electron({
        main: {
          ...
          entry: {
            ...
            'captions/local-inference-runtime': 'electron/captions/local-inference-runtime.js',
            ...
            'captions/pending-audio-retention': 'electron/captions/pending-audio-retention.js',
            'captions/priority-task-queue': 'electron/captions/priority-task-queue.js',
            'captions/processing-configuration': 'electron/captions/processing-configuration.js',
            ...
            'captions/transcription-backends': 'electron/captions/transcription-backends.js',
            'captions/translation-backends': 'electron/captions/translation-backends.js',
            'captions/translation-policy': 'electron/captions/translation-policy.js',
